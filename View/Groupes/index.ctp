<div class="groupes index">
	...
	<tr>
		...
		<td><?php echo h($groupe['Groupe']['lib']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $groupe['Groupe']['id']), null, __('Are you sure you want to delete # %s?', $groupe['Groupe']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
