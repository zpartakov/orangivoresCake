<div class="contacts index">
	...
	<tr>
		...
		<td><?php echo h($contact['Contact']['code_postal']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['commune']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['telephone']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['natel']); ?>&nbsp;</td>
